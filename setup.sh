...
echo -e "\e[34m"
echo "╔═══════════════════════════════════════════╗"
echo "║       HUNTER TOOL v2.0 - KURULUM         ║"
echo "╚═══════════════════════════════════════════╝"
echo -e "\e[0m"

echo -e "\e[33m[*] Gereksinimler yükleniyor...\e[0m"
pkg update && pkg upgrade -y
pkg install git python python3 curl wget nmap php ruby perl ncurses-utils figlet toilet -y
pip install --upgrade pip
pip install requests mechanize beautifulsoup4 rich colorama

echo -e "\e[33m[*] Hunter Tool indiriliyor...\e[0m"
cd ~
mkdir -p hunter-tool
cd hunter-tool

cat > hunter.sh << 'HUNTEREOF'
#!/bin/bash
...
echo -e "\e[32m"
echo "╔═══════════════════════════════════════════╗"
echo "║       HUNTER TOOL BAŞARIYLA KURULDU!     ║"
echo "╚═══════════════════════════════════════════╝"
echo -e "\e[0m"
echo -e "\e[33mKullanmak için:\e[0m"
echo -e "\e[36m  cd ~/hunter-tool && bash hunter.sh\e[0m"
echo ""
